...
\part{Protect}\label{protect}\index{protect}
\chapter{Ecosystem}\label{protect_ecosystem}\index{protect ecosystem}
General idea, vision, values\ldots brand what frame agreement defined ecosystem
...
\section{Customer}\label{protect_customer}\index{protect customer}

\section{Influencer}\label{protect_influencer}\index{protect influencer}

\section{Vendor}\label{protect_vendor}\index{protect vendor}

\section{Bank}\label{protect_bank}\index{protect bank}

\section{Trade operator}\label{protect_trade_operator}\index{protect trade
operator}

\section{Ecosystem platform}\label{protect_ecosystem_platform}\index{protect
ecosystem platform}

\subsection{Technology}\label{protect_technology}\index{protect technology}

\subsection{Ownership}\label{protect_ownership}\index{protect ownership}

\subsection{Frame agreement}\label{protect_frame_agreement}\index{protect
frame agreement}
