...
Dependency Resolution artificial intelligence
DRai\textsuperscript{\texttrademark} and Digital Trade Market Value Growth
DTMVG\textsuperscript{\texttrademark}

\includegraphics[height=32pt,width=32pt]{figures/resolgb.eps}
\includegraphics[height=32pt,width=32pt]{figures/resoaigb.eps}
\includegraphics[height=32pt,width=32pt]{figures/dtmvgb.eps}
.
\vspace*{\fill}
