...
%	.
%	Document is edited as work on process, which means that at the first is
%	written those parts which are needed to explain how ecosystem can be
%	set up and related roles on ecosystem. Then based of description is
%	added frame agreement details. Later on actual legal text is formed and
%	book can be reordered for fast adobtion on later editions.
%	
%
...
%\usepackage{verbatim}
%\usepackage{hyphenat}
%\hyphenation{e-com-mer-ce com-mer-ce mind-ed ex-ist-ing en-tre-pre-neurs}
