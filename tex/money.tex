...
%\item Local current revaluation (indirectly devaluates other currencies if/when there is any trade)
\end{itemize}
...
%\item Government tax
%\item Government toll, decrease global money amount, when government money equated to central bank money
%Relativistic Local/Global Zero Sum game operations are not listed:
%\item Local current devaluation (indirectly revaluates other currencies if/when there is any trade)
\end{itemize}
