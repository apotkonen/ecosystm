...
lends to loose purchasing power \cite{FedFOMC260617}. It looks that leader
from US, which currency dollar has been reserve currency, is counting that
amount of currency carried overseas is so big, that it is beneficial to them
to initialize high inflation while maintain low federal bank overnight
