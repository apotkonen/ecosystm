...
And lack of similar also non-returnable cases covering Global Individual Asset
Identifier (GIAI)\cite{GIAI}\cite{CajoMakeBright}. Note: Here Asset means
actual physical item, and in further text we use only abbreviations GIAI
and GRAI to avoid mix to this document own asset defintion.
